...
function GetSldId() { return sId=location.href.substring(location.href.lastIndexOf('../../index.html')+1) }
...
var ENDSHOW_MESG="End of slide show, click to exit.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=7, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.html";
...
var gMainDoc=new Array(new hrefList("slide0001.html",1,-1,1),new hrefList("slide0002.html",1,-1,1),new hrefList("slide0010.html",1,-1,1),new hrefList("slide0022.html",1,-1,1),new hrefList("slide0023.html",1,-1,1),new hrefList("slide0015.html",1,-1,1),new hrefList("slide0024.html",1,-1,1));
...
function CalculateMHTMLPrefix()
{
	if ( document.location.protocol == 'mhtml:') {
		...
		End=href.lastIndexOf('../../index.html')+1
		if (End < Start)
